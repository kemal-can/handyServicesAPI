...
class ProductsController extends Controller
{
    ...
    public function getById(Request $request){
        ...
        $storeInfo = Freelancer::select('id','uid','name','status')->where('uid',$data->freelacer_id)->first();
        $cateData  = ProductCategory::where('id',$data->cate_id)->first();
        $subCateData = ProductSubCategory::where('id',$data->sub_cate_id)->first();
        $response = [
            'data'=>$data,
            'related'=>$related,
            'soldby'=>$storeInfo,
            'cate'=>$cateData,
            'sub_cate'=>$subCateData,
            'success' => true,
            'status' => 200,
        ];
        return response()->json($response, 200);
    ...
    public function getAll(){
        ...
        ->select('products.*','users.first_name as first_name','users.last_name as last_name','users.cover as freelancer_cover')
    ...
    public function getByCateAndSubCate(Request $request){
        $validator = Validator::make($request->all(), [
            'cate_id' => 'required',
            'sub_cate_id' => 'required',
        ]);
    ...
    public function topProducts(Request $request){
        ...
        $data = Products::WhereIn('id',$ids)->get();
        $response = [
            'data'=>$data,
            'success' => true,
            'status' => 200,
